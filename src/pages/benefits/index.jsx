  ...
  const benefits = [
    {
      ...
      description:
        "Diminua significativamente os índices de acidentes de trabalho e afastamentos, protegendo seus colaboradores.",
    },
    {
      icon: <TrendingUp className="w-6 h-6 text-yellow-600" />,
      title: "Aumento de produtividade",
      description:
        "Ambientes seguros e saudáveis promovem maior engajamento, reduzem o absenteísmo e melhoram a produtividade.",
    },
    {
      icon: <Award className="w-6 h-6 text-yellow-600" />,
      title: "Credibilidade no mercado",
      description:
        "Demonstre comprometimento com a segurança e fortaleça a imagem da sua empresa perante clientes e parceiros.",
    },
  ];
  ...
  return (
    <section id="benefits" className="py-20 relative">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.pexels.com/photos/3862130/pexels-photo-3862130.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")',
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Empresas que investem em segurança reduzem acidentes, aumentam a
            produtividade e transmitem credibilidade no mercado.
          </p>
        </div>
